            ...
            <div className='flex flex-col justify-between items-center '>
                <div className='w-full'>
                    <div className='flex'>
                        ...
                        <div className='items-center gap-5'>
                            ...
                            <p className='text-sm text-gray-600 m-0 font-semibold '>{props.ride?.pickupLocation}</p>
                        </div>
                    </div>
                    <div className='flex'>
                ...
                <div className='flex mt-5 w-full items-center justify-between'>
                    ...
                    <button onClick={() => {
                        ...
                        if (props.ride?.destination && props.ride.destination !== defaultDestination) {
                            props.confirmRide();
                        } else {
                            props.confirmEmergencyRide();
                        }
