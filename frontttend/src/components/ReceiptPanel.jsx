...
const ReceiptPanel = (props) => {
    ...
    return (
        <div>
            ...
            <h3 className='text-2xl font-semibold mb-3 mt-0'>confirm Payment</h3>
            ...
            <div className='flex flex-col justify-between items-center '>
                <div className='w-full'>
                    <div className='flex'>
                        ...
                        <div className=' items-center gap-5'>
                            ...
                            <p className='text-medium text-gray-600 mt-3 font-semibold '>{props.ride?.pickupLocation}</p>
                        </div>
                    ...
                    <div className='flex'>
                        ...
                        <div className=' items-center gap-5'>
                            {/* <h3 className='text-lg  font-bold m-0'>562/11-A</h3> */}
                            <p className='text-sm text-gray-600 mt-3 font-semibold '>{props.destination}</p>
                        </div>
                    </div>
                    <div className='flex'>
                ...
                <div className='mt-6 w-full'>
                    <button onClick={endRide} className='flex items-center mt-5 justify-center w-full rounded-lg p-3 bg-green-600 text-white font-semibold'>Cash Payment</button>
                </div>
            </div>
